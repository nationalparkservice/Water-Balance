...
#Penmon-Monteith ET varibales (Daymet)
...
dayl = r''          ##Direcotry with the Day Length variables
...
def solarDeclination(month):
    try:        #Get Julian Day
        ...
        equation = var4 * var5
        #equation = (math.sin(((360.0/365.0)*(dayMid - 81))) * (math.sin(23.45)))  #Equation in One Calculation - Struggled to get this work -KRS
...
def Penman_Montieth(month):

    try:


        #Top Left Term of FAO Penman-Monteith (0.408 Delta(Rn-G))
        outPenman_topLeft = Penman_topLeft(netRadiation)
...
#Top Left Term of FAO Penman-Monteith (0.408 Delta(Rn-G)
def Penman_topLeft(monthlyRadiation, month):
    ...
    try:
        ...
        #Finished lagic for delta variable - 20180122 - KRS
...
def calc_Ra(inverse_rel_distance,sunset_hour_angle,latitude,solar_declination): #CHECKS OK
...
##    return Ra
    ...
    latSin_NP = numpy.sin(latitude_NP)
    del latitude_NP
    ...
    ### Stopped here on 20180204 1:34 pm - KRS  need to calculated sunset_hour_angle
